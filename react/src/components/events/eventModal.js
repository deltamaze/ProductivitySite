...
import * as eventAction from '../../store/actions/eventCollectionActions';
            ...
            >
                ...
                <Modal.Body>
                    <>
                        ...
                        {/* Repeat Every [Frequency Number][Frequency Type(Day,Week,Month,Year)] */}
                        <div>
                            Repeat Every
                            ...
                            this.props.events.monthTypeSelection === 'Day Number'
                                ...
                                ? (
                                    <div style={{ fontStyle: 'italic', fontSize: 'small' }}>
                                        ...
                                        when Day Number = {this.props.events.startDate.split('-')[2]}
                                    </div>
                                ) : null
                        }
                        {
